...
const DocumentUploadField = ({ label, id, placeholder, subContent }) => (
  <div className="flex flex-col gap-2">
    ...
    <div className="relative border border-[#D1B3B8] w-[25vw] p-2 flex items-center gap-2">
      <svg
      ...
      />
      <span className="text-[rgba(51,51,51,0.40)] font-montserrat text-[12.715px] font-normal leading-[16.953px]">
        {placeholder}
      </span>
    </div>
  </div>
    ...
    <div className="overflow-y-scroll flex flex-col w-[80vw] h-[75vh] p-6 bg-[#5C0E1405]">
      <div className="flex flex-col w-[80%] h-[100%] gap-6">
        ...
        <div className="flex justify-between">
          ...
          />
          <div className="flex flex-col gap-2">
            <label htmlFor="duration" className="text-[16px] font-montserrat">
            ...
            <input
              type="date"
              id={4}
              className="border border-[#D1B3B8] p-2 w-[25vw] text-[13.893px] font-montserrat placeholder-[rgba(51, 51, 51, 0.40)] leading-[18.524px] focus:outline-none focus:ring-2 focus:ring-[#D1B3B8]"
            />
          </div>
        </div>
        ...
        <div className="flex items-start gap-2">
          ...
          <label
            htmlFor={6}
            className="text-[12.715px] font-montserrat text-[rgba(51, 51, 51, 0.40)] leading-[16.953px]"
          >
            I confirm that I have not been convicted by a court in India for any
            criminal offense and/or sentenced to imprisonment. There are no
            criminal proceedings pending against me before any court in India. I
            have not been issued a warrant or summons for appearance or a
            warrant for arrest by any court in India. I certify that the above
            statements made by me are true, complete and correct. I agree that
            in case VIT finds at any time that the information given by me in
            this form is not correct or incomplete, VIT will have the right to
            withdraw my letter of appointment or to terminate my appointment at
        ...
        <div className="flex justify-between pb-6">
          ...
          <div className="flex justify-center items-center border border-[#5C0E14] bg-[#650010] shadow-[0px_10px_30px_0px_rgba(101,0,16,0.2)] w-[40vw] text-white">
            <button className="font-montserrat text-[16px]">Submit</button>
          </div>
        </div>
      </div>
    </div>
...
export default DocumentsUploadMainPage;
