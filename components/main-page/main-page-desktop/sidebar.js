...
const Button = ({ children, className, onClick }) => (
  <button
    className={`flex items-center self-stretch py-4 text-gray-900 font-montserrat text-[16px] font-medium ${className}`}
    onClick={onClick}
  >
    {children}
  </button>
  ...
  return (
    <div className="w-[20vw] h-[80vh] p-[24px_32px] flex flex-col gap-4 border-r-[1px] border-gray-300 bg-white">
      ...
      <div className="flex flex-col pb-3">
        ...
        <p className="text-black font-montserrat text-[13px] font-normal">
