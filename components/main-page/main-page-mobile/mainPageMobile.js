    ...
    <div className="w-full h-screen flex flex-col">
      <div className="flex-grow flex flex-col gap-4">
        ...
        <div className="flex flex-col gap-4">
          ...
          <div className="flex flex-col justify-start items-center gap-4 w-[100%]">
                  ...
                  <g id="calendar">
                    <g id="Vector">
                      <path
                        fillRule="evenodd"
                        clipRule="evenodd"
                        d="M5.50016 4.79167C4.92487 4.79167 4.4585 5.25804 4.4585 5.83333V15.8333C4.4585 16.4086 4.92487 16.875 5.50016 16.875H15.5002C16.0755 16.875 16.5418 16.4086 16.5418 15.8333V5.83333C 16.5418 5.25804 16.0755 4.79167 15.5002 4.79167H5.50016ZM3.2085 5.83333C3.2085 4.56768 4.23451 3.54167 5.50016 3.54167H15.5002C16.7658 3.54167 17.7918 4.56768 17.7918 5.83333V15.8333C17.7918 17.099 16.7658 18.125 15.5002 18.125H5.50016C4.23451 18.125 3.2085 17.099 3.2085 15.8333V5.83333Z"
                        fill="#111827"
                      />
                      <path
                        fillRule="evenodd"
      ...
      <footer className="w-full bg-[#650010] text-white text-center p-4 text-[#FDFEFF] font-[Emilio-Test] text-[12px] font-semibold">
